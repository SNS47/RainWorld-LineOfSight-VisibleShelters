...
namespace LineOfSight
{
    class OptionsMenu : OptionInterface
    {
        ...
        public override void Initialize()
        {
            ...
            visibilitySlider = new OpSlider(visibility, new Vector2(50 + visibilityMin * 3, 400), 300 - visibilityMin * 3) { min = visibilityMin, max = 100, hideLabel = false, description = "Default: 80 - How visible unseen areas of the map are. Lower values fade into a solid color." };
            ...
            renderingTab.AddItems( //create an array of ui elements
                ...
                new OpSlider(brightness, new Vector2(50, 300), 300) { max = 100, hideLabel = false, description = "Default: 80 - Brightness of the unseen area color, which is based on the room's pallete. 0 is black." },
                new OpLabel(365, 306, "Unseen Area Brightness"),
                new OpSlider(tileSize, new Vector2(50, 200), 300) { min = 2, max = 10, hideLabel = false, description = "Default: 8 - Size of tiles when calculating line of sight. Low values improve visibility in tunnels and around corners. 10 is the actual size of tiles." },
                new OpLabel(365, 206, "Tile Size"),
                new OpSlider(viewRange, new Vector2(50, 100), 300) { min = 5, max = 100, hideLabel = false, description = "Default: 80 - Maximum radius in tiles around the player that can be visible." },
                new OpLabel(365, 106, "View Range")
                );
